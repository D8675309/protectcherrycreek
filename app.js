...
const TO_PLANNING = 'mlmartin@valdostacity.com';
const COUNCIL_EMAILS = [
  'sjmatheson@valdostacity.com',   // Mayor Scott Matheson
  'vmiller-cody@valdostacity.com', // District 1 - Vivian Miller-Cody
  'stooley@valdostacity.com',      // District 2 - Sandra Tooley
  'tmcintyre@valdostacity.com',    // District 3 - Thomas McIntyre
  'ehoward@valdostacity.com',      // District 4 - Eric Howard
  'tcarroll@valdostacity.com',     // District 5 - Tim Carroll
  'agibbs@valdostacity.com',       // District 6 - Andy Gibbs
  'nharden@valdostacity.com'       // At-Large - Nick Harden
];
const TO_COUNCIL = COUNCIL_EMAILS.join(',');
const SUBJECT = 'Opposition to Rezoning Case VA-2026-02 — Lake Laurie Drive';
...
function update() {
  ...
  var reLine = '<p class="re-line"><strong>RE:</strong> Opposition to Rezoning Request VA-2026-02 — RST Construction / Lake Laurie Drive</p>';

  var salutation = '<p>Dear Members of the Planning Commission' + (ccChecked ? ' and Mayor and City Council' : '') + ':</p>';

  var body =
    '<p>I am a resident of ' + blank('f-street','[Your Street/Neighborhood]') + ', located at ' + blank('f-address','[Your Address]') + ', Valdosta, Georgia. I am writing in strong opposition to Rezoning Case VA-2026-02, the request by RST Construction to rezone approximately 5.20 acres on the north side of Lake Laurie Drive from Single-Family Residential (R-15) to Multi-Family Residential (R-M).</p>' +
    ...
    '<h4>2. Proposed Density Is 4-5x Greater Than Appropriate</h4>' +
    '<p>The current R-15 zoning would yield approximately 10–15 single-family homes on the 5.20-acre parcel. The proposed R-M rezoning would permit, at minimum:</p>' +
    '<ul>' +
    ...
    '<p>Despite the significant scale of this proposal, no traffic study, drainage study, environmental study, or infrastructure capacity analysis has been submitted with this application. The impacts of 64+ units on local roads, stormwater systems, and public utilities have not been quantified or disclosed. I respectfully urge the Planning Commission to require these studies before making any recommendation.</p>' +
...
function buildPlainText() {
  ...
  var street  = raw('f-street', '[Your Street/Neighborhood]');
...
'RE: Opposition to Rezoning Request VA-2026-02 — RST Construction / Lake Laurie Drive\n\n' +
salutation + '\n\n' +
'I am a resident of ' + street + ', located at ' + address + ', Valdosta, Georgia. I am writing in strong opposition to Rezoning Case VA-2026-02, the request by RST Construction to rezone approximately 5.20 acres on the north side of Lake Laurie Drive from Single-Family Residential (R-15) to Multi-Family Residential (R-M).\n\n' +
...
'The current R-15 zoning would yield approximately 10-15 single-family homes on the 5.20-acre parcel. The proposed R-M rezoning would permit, at minimum:\n\n' +
...
'4. THE CONCEPT PLAN IS NOT BINDING -- THE TRUE RISK IS GREATER THAN SHOWN\n\n' +
